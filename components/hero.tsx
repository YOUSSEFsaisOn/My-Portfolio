  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          I&apos;m <span className="text-white font-semibold">Yousef Mohamed</span>, a Senior Frontend Developer specializing in
          high-performance React applications and immersive user interfaces.
        </motion.p>
