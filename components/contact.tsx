...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 px-6 relative overflow-hidden bg-[#050812]">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-16">
          ...
          >
            ...
            <div className="p-8 glass rounded-3xl bg-blue-600/5 border-blue-500/20">
              <h4 className="text-xl font-bold text-white mb-2">Available for projects</h4>
              <p className="text-slate-400">I&apos;m currently accepting new freelance projects and full-time opportunities. Reach out and let&apos;s discuss your needs.</p>
            </div>
          </motion.div>
        ...
        <div className="mt-24 pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-slate-500 text-sm">
