...
const ALL_PROJECTS = [
  {
    ...
    description: 'Next.js · .NET · React Query · TypeScript · Paymob · Bunny.net · Admin Dashboard',
  ...
  },
  {
    ...
    description: 'Next.js · .NET · React Query · TypeScript · Paymob · Bunny.net',
  ...
  },
  {
    ...
    description: 'Built a secure authentication app with Google Sign-In and Email/​Password login using Firebase Authentication',
    shortDescription: '•Built a secure authentication app with Google Sign-In and Email/​Password login using Firebase Authentication',
  ...
  },
  {
    ...
    description: 'Developed a full-stack notes management application with CRUD functionality using Next.js and .NET Web API.• Implemented secure ',
    shortDescription: 'Developed a full-stack notes management application with CRUD functionality using Next.js and .NET Web API Implemented secure authentication and protected routes with JWT.• Designed a responsive UI with clean state management and real-time user feedback ',
